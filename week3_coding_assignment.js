...
let myNames = ["Sam", "Tommy", "Tim", "Sally", "Buck", "Bob"];
let sumOfLetters = 0;

for (var index of myNames) {
    sumOfLetters = sumOfLetters + index.length;
}
let myNamesAverage = sumOfLetters / myNames.length;
console.log(myNamesAverage);
